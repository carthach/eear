...
Array<File> TheEarPluginAudioProcessorEditor::getAudioFiles(const File& audioFolder, String key, String scale)
{
...
void TheEarPluginAudioProcessorEditor::changeListenerCallback (ChangeBroadcaster *source)
{
...
void TheEarPluginAudioProcessorEditor::timerCallback()
{
...
void TheEarPluginAudioProcessorEditor::sliderValueChanged (Slider* slider)
{
...
void TheEarPluginAudioProcessorEditor::sliderDragStarted (Slider* slider)
{
    if (AudioProcessorParameter* param = getParameterFromSlider (slider))
    {
...
void TheEarPluginAudioProcessorEditor::sliderDragEnded (Slider* slider)
{
    if (AudioProcessorParameter* param = getParameterFromSlider (slider))
    {
...
void TheEarPluginAudioProcessorEditor::buttonClicked(Button* button)
{
...
AudioProcessorParameter* TheEarPluginAudioProcessorEditor::getParameterFromSlider (const Slider* slider) const
{
...
void TheEarPluginAudioProcessorEditor::displayPositionInfo (const AudioPlayHead::CurrentPositionInfo& pos)
{
