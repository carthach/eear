...
*/
class TheEarPluginAudioProcessor  : public AudioProcessor
{
public:
    //==============================================================================
    TheEarPluginAudioProcessor();
    ~TheEarPluginAudioProcessor();
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (TheEarPluginAudioProcessor)
};
